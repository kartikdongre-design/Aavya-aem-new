...
function getFallbackFooterHtml() {
  ...
  return [
    ...
    '<span class="footer__logo-ar" dir="rtl" lang="ar">السعودية للسيراميك</span>',
    '<span class="footer__logo-en">Saudi Ceramics</span>',
    '</span></a>',
    ...
    '<a href="mailto:support@saudiceramics.com">support@saudiceramics.com</a></li>',
